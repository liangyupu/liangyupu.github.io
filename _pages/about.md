...
# News
**[2026.03] 📄** Our new work has been accepted by IJCNN 2026.

**[2026.03] 📄** Our new work **MMTIT-Bench** has been accepted by CVPR 2026.

**[2025.10] 📄** Our new work has been accepted by PRCV 2025.

**[2025.09] 🏁** DIMT25@ICDAR has successfully concluded. [\[Competition Report\]](https://link.springer.com/chapter/10.1007/978-3-032-04630-7_29)

**[2025.08] 📄** Our new work **SHIFT** has been accepted by EMNLP 2025.
...
**[2024.02] 📄** Our new work **BabyNet** has been accepted by LREC-COLING 2024.
...
4. Junhong Liang, Junnan Zhu, **Yupu Liang**, Bojun Zhang, Feifei Zhai, Yu Zhou. ***Length-Aware Chinese Spelling Correction with Retrieval and Iterative Refinement***. Proceedings of the International Joint Conference on Neural Networks (**IJCNN 2026**). 2026.
5. Gengluo Li, Chengquan Zhang, **Yupu Liang**, Huawen Shen, Yaping Zhang, Pengyuan Lyu, Weinong Wang, Xingyu Wan, Gangyan Zeng, Han Hu, Can Ma, Yu Zhou. ***MMTIT-Bench: A Multilingual and Multi-Scenario Benchmark with Cognition–Perception–Reasoning Guided Text-Image Machine Translation***. Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition 2026 (**CVPR 2026**). 2026. [\[CVF\]](https://openaccess.thecvf.com/content/CVPR2026/html/Li_MMTIT-Bench_A_Multilingual_and_Multi-Scenario_Benchmark_with_Cognition-Perception-Reasoning_Guided_Text-Image_CVPR_2026_paper.html)
6. Zhiyuan Chen, Yaping Zhang, Zhiyang Zhang, **Yupu Liang**, Yue Xu, Yunfei Lu, Dandan Tu, Chengqing Zong, Yu Zhou. ***Boosting Document Image Translation via Layout-aware Semantic Paragraph Clustering***. Proceedings of the 8th Chinese Conference on Pattern Recognition and Computer Vision (**PRCV 2025**). 2025. [\[Springer\]](https://link.springer.com/book/9789819549863)
7. Yaping Zhang, **Yupu Liang**, Zhiyang Zhang, Zhiyuan Chen, Lu Xiang, Yang Zhao, Yu Zhou, Chengqing Zong. ***ICDAR 2025 Competition on End-to-End Document Image Machine Translation Towards Complex Layouts***. The 19th International Conference on Document Analysis and Recognition (**ICDAR 2025**). 2025. [\[Springer\]](https://link.springer.com/chapter/10.1007/978-3-032-04630-7_29)
8. Boyu Guan, Chuang Han, Yining Zhang, **Yupu Liang**, Zhiyang Zhang, Yang Zhao, Chengqing Zong. **SHIFT: Selected Helpful Informative Frame for Video-guided Machine Translation**. The 2025 Conference on Empirical Methods in Natural Language Processing (**EMNLP 2025**). 2025. [\[ACL Anthology\]](https://aclanthology.org/2025.emnlp-main.161/)
